...
export const metadata: Metadata = {
  title: "Blog | Samad Saiyed",
  description:
    "Articles on React, TypeScript, web development, architecture, and modern frontend tooling by Samad Saiyed.",
  alternates: { canonical: "https://samad-saiyed.vercel.app/blog" },
  openGraph: {
    title: "Blog | Samad Saiyed",
    description:
      "Articles on React, TypeScript, web development, architecture, and modern frontend tooling.",
    url: "https://samad-saiyed.vercel.app/blog",
    type: "website",
  },
};
